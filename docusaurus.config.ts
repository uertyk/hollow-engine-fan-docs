...
const config: Config = {
  ...
  tagline: 'Давайте изучать сюжеты!',
  ...
  baseUrl: '/hollow-engine-fan-docs/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'uertyk', // Usually your GitHub org/user name.
  projectName: 'hollow-engine-fan-docs', // Usually your repo name.
